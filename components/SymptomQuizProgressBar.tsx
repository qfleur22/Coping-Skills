...
export function SymptomQuizProgressBar({ currentSlug }: SymptomQuizProgressBarProps) {
  ...
  return (
    <div className="fixed top-0 left-0 right-0 bg-white/90 backdrop-blur-sm shadow-md z-40">
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 -top-1">
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs font-medium text-gray-700 mt-1 whitespace-nowrap">Start</span>
            </div>
          </div>
          ...
          <div className="absolute right-0 -top-1">
            <div className="flex flex-col items-center">
              ...
              <span className="text-xs font-medium text-gray-700 mt-1 whitespace-nowrap">Results</span>
            </div>
          </div>
