            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>More relationship fragility → consider lowering intensity (or using extra GIVE)</li>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                      <li>Are they required (law/moral code/role) to give what I'm asking? YES / NO (asking)</li>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                      <li>Have I done at least as much / am I willing to give too? YES / NO (asking)</li>
                      <li>Do I owe them / do they give me a lot? YES / NO (saying no)</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                      ...
                      <li>Will saying no wreck my self-respect? Does Wise Mind say "no is right"? YES / NO (saying no)</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-6">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                    <li>6 = Refuse firmly, don't give in</li>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  <li>High intensity (5–6): DEAR MAN + FAST, minimal negotiation, strong boundary language</li>
                  <li>Medium (3–4): DEAR MAN + GIVE, clear ask/no with room to negotiate</li>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>What would Wise Mind adjust next time—timing, clarity, or intensity?</li>
                </ul>
              </div>
              ...
              <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div>
                  ...
                  <p className="text-gray-700 ml-4">
                    ...
                    Approach: Refuse firmly, don't give in.<br />
              ...
              <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>If you escalate: do a quick nervous system reset first (TIPP/breath), then use the chart.</li>
