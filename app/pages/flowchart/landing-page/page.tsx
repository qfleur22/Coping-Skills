...
const categories = {
  ...
  'distress-tolerance': {
    ...
    pages: [
      ...
      { label: '<Link href="/pages/distress-tolerance/tipp" className="text-blue-600 hover:text-blue-800 underline">TIPP</Link>', path: '/pages/distress-tolerance/tipp' },
      ...
      { label: '<Link href="/pages/interpersonal-skills/pros-cons" className="text-blue-600 hover:text-blue-800 underline">Pros & Cons</Link>', path: '/pages/interpersonal-skills/pros-cons' },
