          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg space-y-6">
            <div>
              ...
              <p className="text-gray-700">
                ...
                It means: notice the thought, check if it's distorted, then choose a more helpful and believable message—so you can act from Wise Mind instead of getting pushed around by shame, fear, or hopelessness.
              </p>
            </div>
            ...
            <div className="p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              ...
              <p className="text-gray-700">
                If your inner voice is pushing you toward self-harm or you feel in danger, pause this exercise and use Crisis Skills (STOP/TIPP/Reach out for support). You deserve help and safety first.
              </p>
            </div>
          </div>
        </div>
