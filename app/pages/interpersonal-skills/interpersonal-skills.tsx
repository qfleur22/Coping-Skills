            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  ...
                  className="px-6 py-4 bg-blue-900 hover:bg-blue-950 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                ...
                <button
                  onClick={() => router.push('/interpersonal-skills/interpersonal-intensity')}
                  className="px-6 py-4 bg-blue-900 hover:bg-blue-950 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Interpersonal Intensity
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/interpersonal-myths')}
                  className="px-6 py-4 bg-blue-900 hover:bg-blue-950 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Interpersonal Myths & Truths
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/communication-styles')}
                  className="px-6 py-4 bg-blue-900 hover:bg-blue-950 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Communication Styles
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/assertiveness')}
                  className="px-6 py-4 bg-blue-900 hover:bg-blue-950 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Assertive Communication
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/conflict')}
                  className="px-6 py-4 bg-blue-900 hover:bg-blue-950 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Resistance and Conflict
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/finding-friends')}
                  className="px-6 py-4 bg-blue-900 hover:bg-blue-950 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Finding Friends
                </button>
