        ...
        <div className="w-full max-w-3xl">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg space-y-6">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Even when you know what to do, anxiety-thoughts can derail you: "They'll hate me," "I don't deserve to ask," "I'll do it wrong," "If they're upset, it means I failed." DBT calls out these belief-traps as barriers to being effective.
              </p>
              <p className="text-gray-700 font-medium mb-2">Common signs:</p>
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
            ...
            <div>
              ...
              <p className="text-gray-700 mb-4">
                Strong emotion can shut down your ability to use skills you do have—panic makes you avoid, anger makes you attack, shame makes you disappear. DBT emphasizes returning toward Wise Mind (balanced emotion + reason) so you can choose an effective response.
              </p>
              <p className="text-gray-700 font-medium mb-2">Common signs:</p>
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
            ...
            <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <p className="text-gray-700 mt-3">
                DBT interpersonal skills (like DEAR MAN, GIVE, and FAST) are designed to target these exact failure points—by giving you scripts, goal clarity, and ways to stay grounded while you communicate.
              </p>
            </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  onClick={() => router.push('/interpersonal-skills/ending-relationships')}
                  className="px-6 py-4 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Ending Relationships
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/interpersonal-mindfulness')}
                  className="px-6 py-4 bg-blue-500 hover:bg-blue-600 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Interpersonal Mindfulness
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/dear-man')}
                  className="px-6 py-4 bg-blue-400 hover:bg-blue-500 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  DEAR MAN
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/fast')}
                  className="px-6 py-4 bg-blue-300 hover:bg-blue-400 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  FAST
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/give')}
                  className="px-6 py-4 bg-blue-200 hover:bg-blue-300 text-white font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  GIVE
                </button>
                <button
                  onClick={() => router.push('/interpersonal-skills/intensity')}
                  className="px-6 py-4 bg-blue-100 hover:bg-blue-200 text-gray-800 font-semibold rounded-lg transition-colors duration-200 shadow-md"
                >
                  Intensity
                </button>
              </div>
