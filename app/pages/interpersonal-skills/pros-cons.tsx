          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg space-y-6">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4 mb-4">
                <li>Pros/Cons of tolerating distress (coping / not acting on urges)</li>
                <li>vs.</li>
                <li>Pros/Cons of not tolerating distress (acting on urges / impulsive coping)</li>
              </ul>
            ...
            <div>
              ...
              <div className="mb-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <p className="text-gray-700 mb-2">
                  ...
                  Cons of acting: can't return, shame later, conflict<br />
              ...
              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  <li>"Pros/cons of going to bed on time"</li>
                  <li>"Pros/cons of not sending the third follow-up text"</li>
                  <li>"Pros/cons of taking a 10-minute walk instead of doomscrolling"</li>
                </ul>
                <p className="text-gray-700 mt-3">
