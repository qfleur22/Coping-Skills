          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                    <li>Keep eyes open and maintain awareness of your surroundings</li>
                    ...
                    <li>Have an exit plan and stop if you feel activated</li>
            ...
            <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                ...
                <li>Be kind to yourself: A "busy" meditation session still counts</li>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                ...
                <li>Increases self-awareness and interoception</li>
                <li>Can reduce symptoms of depression and improve overall well-being</li>
              </ul>
              <p className="text-gray-700 mt-3 text-sm italic">
