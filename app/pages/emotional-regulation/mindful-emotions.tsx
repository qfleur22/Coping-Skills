          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg space-y-6">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4 mb-4">
                ...
                <li>You want to stop reacting automatically (snapping, spiraling, self-medicating, shutting down).</li>
                <li>You want to reduce suffering without needing the emotion to vanish first.</li>
              </ul>
              <p className="text-gray-700 mb-3 font-semibold">Use a crisis skill first (like TIP/STOP/self-soothe) when:</p>
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4 mb-4">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 ml-4">That can happen at first. If intensity rises past what you can safely hold, switch to a crisis skill (TIP, grounding, self-soothe), then return when you're steadier.</p>
                </div>
                <div>
