      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-4rem)]">
        <div className="w-full max-w-3xl">
          <h1 className="text-4xl font-bold mb-8 text-center text-gray-800">
            Self-Care Check-In: Are you adequately hydrated, medicated, nourished, & rested?
          </h1>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg space-y-6">
            ...
            <div className="mt-6 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
              ...
              <p className="text-gray-700">
                That's a signal you may need <a href="/distress-tolerance" className="text-blue-600 hover:text-blue-800 underline">Distress Tolerance</a> first (crisis-survival skills), or extra support. DBT explicitly pairs body-care (PLEASE) with skills for intense moments.
              </p>
            </div>
          </div>
        </div>
