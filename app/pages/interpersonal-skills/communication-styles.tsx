          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg space-y-6">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                ...
                <li>Choose small, practical shifts toward assertive communication (the DBT "sweet spot")</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 mb-2"><strong>Goal:</strong> prevent conflict / rejection</p>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 mb-2"><strong>Goal:</strong> prevent vulnerability / gain control / stop feeling powerless</p>
            ...
            <div>
              ...
              <ol className="list-decimal list-inside space-y-1 text-gray-700 ml-4">
                ...
                <li>What do you get short-term? (peace, distance, control, no conflict)</li>
