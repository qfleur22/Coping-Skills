  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-24">
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  <li><strong>Yes, it fits the facts.</strong><br />
                    → Use <a href="/problem-solve" className="text-blue-600 hover:text-blue-800 underline">Problem Solving</a> (change the situation) or <a href="/interpersonal-skills" className="text-blue-600 hover:text-blue-800 underline">Interpersonal Skills</a> (if it's a people problem).</li>
                  <li><strong>No, it doesn't fit the facts (or it's too intense).</strong><br />
                    → Use <a href="/opposite-action" className="text-blue-600 hover:text-blue-800 underline">Opposite Action</a> or another emotion regulation skill to shift the emotion.</li>
      ...
      <div className="fixed bottom-6 right-6 flex flex-col gap-2 z-50">
        <button
          onClick={() => router.push('/change-situation')}
