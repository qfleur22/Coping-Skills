          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-lg p-8 shadow-lg space-y-6">
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4 mb-4">
                ...
                <li>half-smile, and willing hands,</li>
                <li>and the repeated choice called Turning the Mind (choosing acceptance again and again).</li>
              </ul>
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4 mb-3">
                <li>Soften your face slightly into a gentle half-smile (not forced).</li>
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>If you can, add half-smile for 2 breaths.</li>
                </ol>
                <p className="text-gray-700 mt-3 text-sm italic">
              ...
              <div className="mb-6">
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>End with one breath and a tiny half-smile.</li>
                </ol>
              </div>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 mb-2 font-medium">Steps</p>
                <ol className="list-decimal list-inside space-y-1 text-gray-700 ml-4">
                  <li>Give yourself 5 extra minutes if you can.</li>
              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <ol className="list-decimal list-inside space-y-1 text-gray-700 ml-4 mb-3">
                  ...
                  <li>Turn the mind (choose acceptance for this moment):
                    <ul className="list-disc list-inside ml-6 mt-1">
                      <li>"I don't like it, but I can stop fighting what's true."</li>
                    </ul>
                  </li>
                  <li>Willing posture (10 seconds):
                    <ul className="list-disc list-inside ml-6 mt-1">
                      <li>willing hands + half-smile + long exhale.</li>
                    </ul>
                  </li>
                </ol>
              </div>
