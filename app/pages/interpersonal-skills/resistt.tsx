            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4 mb-3">
                  ...
                  <li>If you can, do a quick Check the Facts: What do I know vs. what am I predicting?</li>
                </ul>
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-700 mb-3">Give your mind content that doesn't escalate.</p>
                <p className="text-gray-700 mb-2 font-medium">Options</p>
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>If you keep needing breaks daily, that's a vulnerability flag → use your "Overwhelmed?" page + ABC PLEASE / basics.</li>
                </ul>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>When you're flooded: start with I (Intense) or E (Engage) first (fast body/attention wins), then do R once you're below ~6/10.</li>
                </ul>
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-gray-700"><strong>"You keep cycling RESISTT and staying at 8–10."</strong> → Switch to your Crisis Skills page (STOP/TIP/ACCEPTS) and/or your Overwhelmed? decision page.</p>
                </div>
              </div>
            </div>
          </div>
