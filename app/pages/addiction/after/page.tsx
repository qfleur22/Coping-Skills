          ...
          <div className="bg-red-50 backdrop-blur-sm rounded-lg border border-red-200 p-8 shadow-lg space-y-6">
            ...
            <div>
              <p className="text-gray-700 mb-4">
                If you used, the goal now is safety + stabilization, not shame. A lapse is data. We use it to reduce the odds of the next one.
              </p>
            </div>

            <div>
              <h2 className="text-2xl font-semibold mb-4 text-red-800">
                First: safety + medical check
              </h2>
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                <li>If you're worried about overdose, mixing substances, severe symptoms, or you feel unsafe: <Link href="/pages/crisis-help-now" className="text-blue-600 hover:text-blue-800 underline">Crisis Help Now</Link></li>
            ...
            <div>
              <h2 className="text-2xl font-semibold mb-4 text-red-800">
                Post-crisis debrief (when steadier)
              </h2>
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                <li><Link href="/pages/chain-analysis" className="text-blue-600 hover:text-blue-800 underline">Chain Analysis</Link> (what led here)</li>
                <li><Link href="/pages/solution-analysis" className="text-blue-600 hover:text-blue-800 underline">Solution Analysis</Link> (where to insert skills next time, including cope ahead)</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-700 ml-4 p-4 bg-blue-50 rounded-lg border border-blue-200">
                "I'm sorry. I'm taking steps to be safer. I don't need you to fix it—please just stay connected while I use my plan."
              </p>
              <button
                onClick={() => router.push('/pages/interpersonal-skills/repair')}
                className="mt-3 px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors duration-200"
              >
                Go to Repair
              </button>
            </div>
