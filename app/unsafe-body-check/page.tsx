...
const tooltips = {
  ...
  interpersonalSkills: 'When the feeling is connected to a situation with someone else—conflict, asking for something, saying no, or keeping self-respect. These DBT skills help you communicate clearly and reduce relationship blowups.',
  selfCare: 'In DBT, taking care of your body lowers "emotion vulnerability" (PLEASE skills). When your body is under-resourced, emotions hit harder and coping skills get harder to use. This helps you figure out what you need right now, with small actions that don\'t feel overwhelming.',
};
...
export default function UnsafeBodyCheckPage() {
  ...
  const handleInterpersonalSkills = () => {
    router.push('/interpersonal-skills');
  };
              ...
              {activeTooltip === 'distressTolerance' && (
                <div className="mt-2 bg-white rounded-lg shadow-xl p-4 border border-gray-200 tooltip-container">
                  ...
                  <ul className="list-disc list-inside space-y-1 text-xs text-gray-600 ml-2">
                    <li>A quick "stop the spiral" skill (like STOP or TIPP)</li>
                    <li>Short-term coping (like ACCEPTS distraction tools)</li>
            ...
            <div className="tooltip-container">
              ...
              {activeTooltip === 'interpersonalSkills' && (
                <div className="mt-2 bg-white rounded-lg shadow-xl p-4 border border-gray-200 tooltip-container">
                  ...
                  <p className="text-xs font-semibold text-gray-700 mb-2">What you'll do on the next page (examples):</p>
                  <ul className="list-disc list-inside space-y-1 text-xs text-gray-600 ml-2">
                    <li>DEAR MAN (ask / say no / set a boundary)</li>
                    <li>GIVE (keep the relationship) and FAST (keep self-respect)</li>
                  </ul>
                  <button
                    onClick={() => {
                      setActiveTooltip(null);
