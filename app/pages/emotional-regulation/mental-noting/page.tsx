  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-24">
      ...
      <button
        ...
        className="fixed bottom-16 md:bottom-20 right-0 md:right-6 px-4 md:px-6 py-3 bg-purple-600 hover:bg-purple-700 text-white font-semibold rounded-lg shadow-lg transition-colors duration-200"
      >
        Return to Landing
      </button>
    </div>
