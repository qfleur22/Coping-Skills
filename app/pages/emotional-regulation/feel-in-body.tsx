  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-24">
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>If yes or maybe: continue, but keep it small. (You can stop anytime.)</li>
                </ul>
              </div>
              ...
              <div className="mb-6">
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 ml-4">
                  ...
                  <li>"This is too big right now." → Distress Tolerance (STOP/TIPP)</li>
                  <li>"This is about a situation with someone." → Interpersonal Skills (DEAR MAN / GIVE / FAST)</li>
                  <li>"My body needs basics." → Self-care check (hydration/food/meds/rest)</li>
                </ul>
              </div>
      ...
      <div className="fixed bottom-16 md:bottom-20 right-0 md:right-6 flex flex-col gap-2 z-50 w-full md:w-auto">
        <button
          onClick={() => router.push('/changing-your-feelings')}
