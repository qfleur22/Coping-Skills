              ...
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
                  <li><strong>Yes, it fits the facts.</strong><br />
                    → Use Problem Solving (change the situation) or Interpersonal Skills (if it's a people problem).</li>
                  <li><strong>No, it doesn't fit the facts (or it's too intense).</strong><br />
                    → Use Opposite Action or another emotion regulation skill to shift the emotion.</li>
